...
import 'package:tool_rental_app/Screens/ProfileScreen/basic_screen.dart';
import '../../product_screen.dart';
import '../Posts/add_posts.dart';

class HandTools extends StatefulWidget {
  const HandTools({Key? key}) : super(key: key);

  @override
  State<HandTools> createState() => _HandToolsState();
}

class _HandToolsState extends State<HandTools> {
        ...
        child: Padding(
          ...
          Expanded(
              child: showCartItems
                ...
                query: dbRef.child('Hand Tools').orderByChild('price').limitToFirst(10),
