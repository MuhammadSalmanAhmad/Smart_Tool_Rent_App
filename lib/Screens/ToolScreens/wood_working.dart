...
class WoodWorking extends StatefulWidget {
  const WoodWorking({Key? key}) : super(key: key);

  @override
  State<WoodWorking> createState() => _WoodWorking();
}

class _WoodWorking extends State<WoodWorking> {
            ...
            children: [
              ...
              Expanded(
                child: showCartItems
                  ...
                  query: dbRef.child('Wood Working').orderByChild('price').limitToFirst(10),
