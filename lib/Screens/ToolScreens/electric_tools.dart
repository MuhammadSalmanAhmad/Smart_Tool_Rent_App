...
class ElectricTools extends StatefulWidget {
  const ElectricTools({Key? key}) : super(key: key);

  @override
  State<ElectricTools> createState() => _ElectricTools();
}

class _ElectricTools extends State<ElectricTools> {
            ...
            children: [
              ...
              Expanded(
                child: showCartItems
                  ...
                  query: dbRef.child('Electric Tools').orderByChild('price').limitToFirst(10),
