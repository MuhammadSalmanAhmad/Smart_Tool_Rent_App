...
class WeldingTools extends StatefulWidget {
  const WeldingTools({Key? key}) : super(key: key);

  @override
  State<WeldingTools> createState() => _WeldingTools();
}

class _WeldingTools extends State<WeldingTools> {
            ...
            children: [
              ...
              Expanded(
                child: showCartItems
                  ...
                  query: dbRef.child('Welding Tools').orderByChild('price').limitToFirst(10),
